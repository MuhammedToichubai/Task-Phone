public class Main {
    public static void main(String[] args) {
        ...
        Contact contact1 = new Contact("Begimay Mamytova", "0997997997");
        Contact contact2 = new Contact("Aizat Ysmanova", "0777100200");
        Contact contact3 = new Contact("Erjigit Gairatov", "0222300400");
        Contact contact4 = new Contact("Kanat Saparbaev", "07774000400");

        Contact[] contacts = new Contact[]{contact1, contact2};

        Contact[] contacts2 = new Contact[] {contact3, contact4, contact1, contact2};

        Phone phone1 = new Phone("iphone", "14", 1500, "Aijamal", contacts);
        Phone phone2 = new Phone("samsung", "galaxy s20", 1000, "Mukhammed", contacts2 );
